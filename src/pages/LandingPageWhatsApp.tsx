        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {filters.map((filter, idx) => (
              <Card key={idx} className="hover:bg-gray-800/70 transition-colors">
                <CardHeader>
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <div className="flex items-center justify-center gap-4 mb-8">
              ...
              <button
                ...
                className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${isYearly ? 'bg-purple-600' : 'bg-gray-600'}`}
              >
                <span
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
            {plans.map((plan) => (
              <Card 
                key={plan.id} 
                className={`relative hover:bg-gray-800/70 transition-all duration-300 ${plan.popular ? 'ring-2 ring-purple-600 scale-105' : ''}`}
              >
                {plan.popular && (
                  ...
                  <div className="mt-6">
                    ...
                    {isYearly && (
                      <div className="mt-2">
                        ...
                        <span className="text-green-400 ml-2 font-semibold">Save ${plan.yearlyDiscount}</span>
                      </div>
                    )}
                  </div>
                </CardHeader>
                ...
                <CardContent className="space-y-4">
                  <Button 
                    className={`w-full py-3 text-lg font-semibold ${plan.popular ? '' : 'bg-gray-700 hover:bg-gray-600 text-white'}`}
