  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-900 via-black to-gray-900">
      ...
      <div className="container mx-auto px-6 py-12 max-w-4xl">
        <h1 className="text-4xl font-bold text-white mb-8 text-center">Conditions d'Utilisation</h1>
        ...
        <div className="bg-gray-800/50 backdrop-blur-sm border border-gray-700 rounded-lg p-8 space-y-8">
          ...
          <section>
            <h2 className="text-2xl font-bold text-purple-400 mb-4">Conditions d'utilisation</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold text-purple-400 mb-4">Informations soumises par les utilisateurs et les contributeurs</h2>
            <p className="text-gray-300 leading-relaxed mb-4">
          ...
          <section>
            <h2 className="text-2xl font-bold text-purple-400 mb-4">Limitation de responsabilité</h2>
            <p className="text-gray-300 leading-relaxed mb-4">
          ...
          <section>
            <h2 className="text-2xl font-bold text-purple-400 mb-4">Erreurs</h2>
            <p className="text-gray-300 leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold text-purple-400 mb-4">Liens vers des sites web tiers</h2>
            <p className="text-gray-300 leading-relaxed mb-4">
          ...
          <section>
            <h2 className="text-2xl font-bold text-purple-400 mb-4">Droits d'auteur et propriété intellectuelle</h2>
            <p className="text-gray-300 leading-relaxed mb-4">
          ...
          <section>
            <h2 className="text-2xl font-bold text-purple-400 mb-4">Réclamations pour violation de droits d'auteur</h2>
            <p className="text-gray-300 leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold text-purple-400 mb-4">Contact</h2>
            <p className="text-gray-300 leading-relaxed">
