...
const SecaFacilLanding: React.FC = () => {
  ...
  const purchaseData = [
    { name: 'Marina L.', city: 'São Paulo', plan: 'Fórmula Completa' },
    { name: 'Carlos R.', city: 'Rio de Janeiro', plan: 'Fórmula Completa' },
    { name: 'Julia M.', city: 'Curitiba', plan: 'Fórmula Completa' },
    { name: 'Pedro S.', city: 'Porto Alegre', plan: 'Fórmula Completa' },
    { name: 'Amanda B.', city: 'Brasília', plan: 'Fórmula Completa' },
    { name: 'Ricardo H.', city: 'Belo Horizonte', plan: 'Fórmula Completa' },
    { name: 'Letícia F.', city: 'Salvador', plan: 'Fórmula Completa' },
    { name: 'Bruno C.', city: 'Fortaleza', plan: 'Fórmula Completa' },
    { name: 'Camila D.', city: 'Recife', plan: 'Fórmula Completa' },
    { name: 'Daniel P.', city: 'Florianópolis', plan: 'Fórmula Completa' },
  ];

  const testimonials: Testimonial[] = [
    {
      text: 'Finalmente encontrei algo que funciona! Em poucos dias já notei diferença no suor das mãos e pés.',
      author: 'Ana C.',
    ...
    {
      text: 'Nunca mais passei vergonha em reuniões. Minha autoestima voltou completamente!',
      author: 'Roberto M.',
      location: 'Rio de Janeiro • 35 anos',
      rating: 5,
    ...
    {
      text: 'Super fácil de fazer em casa. Ingredientes simples mas resultado incrível!',
      author: 'Fernanda S.',
  ...
  return (
    <div className="min-h-screen bg-black text-white font-sans overflow-x-hidden">
      ...
      <meta
        name="description"
        content="Seca Fácil: Alivie o suor excessivo em 7 dias com um gel natural caseiro. Sem químicos, com garantia de 7 dias. Apenas R$5,00 vitalício."
      />
      <noscript>
        <img
          height="1"
      ...
      {showOffer && (
        <div className="fixed top-0 left-0 right-0 bg-gradient-to-r from-red-600 to-red-500 text-white text-center font-bold py-3 px-4 z-50 shadow-lg animate-[slideDown_0.5s_ease-out]">
          <div className="flex items-center justify-center gap-2 text-sm md:text-base">
            ...
            <span>OFERTA LIMITADA: R$5,00 VITALÍCIO • Restam apenas <span className="bg-white text-red-600 px-2 py-1 rounded-full font-black">{spots}</span> vagas</span>
            <span className="animate-pulse">⚡</span>
          </div>
        </div>
      )}
      ...
      <section className="min-h-screen flex items-center justify-center px-4 py-12 md:py-20 pt-16 md:pt-20">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <h1 className="text-[clamp(28px,6vw,64px)] font-black leading-tight mb-5 bg-gradient-to-r from-white to-[#00FF88] bg-clip-text text-transparent overflow-visible whitespace-normal">
            Alivie o Suor Excessivo em Apenas 7 Dias
          </h1>
          <p className="text-[clamp(16px,2.5vw,20px)] text-gray-200 mb-10 max-w-[600px] mx-auto">
            A solução natural para quem sofre com suor excessivo. Nosso <span className="text-[#00FF88] font-bold">Gel Natural de Alívio para Suor</span> reduz a hiperidrose sem químicos agressivos, devolvendo sua confiança.
          </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 md:gap-8 mb-8 md:mb-12 max-w-2xl mx-auto">
            {[
              { number: '97%', label: 'Taxa de Sucesso' },
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12 md:mb-16">
            ...
            <p className="text-lg md:text-xl text-gray-200 max-w-2xl mx-auto">
              Alivie o suor excessivo com nosso Gel Natural de Alívio para Suor em apenas 7 dias
            </p>
          </div>
            ...
            {[
              {
                ...
                desc: 'Compre o Seca Fácil e receba acesso imediato',
                color: 'from-blue-400 to-blue-500'
              },
              {
                icon: '🧪',
                title: '2. Prepare o Gel',
                desc: 'Faça o gel natural em casa com ingredientes simples',
                color: 'from-purple-400 to-purple-500'
              },
              {
                icon: '⏱️',
                title: '3. 7 Dias de Ação',
                desc: 'Aplique o gel diariamente por 7 dias para alívio rápido',
                color: 'from-yellow-400 to-orange-400'
              },
              {
                icon: '😊',
                title: '4. Viva com Confiança',
                desc: 'Volte a viver sem o constrangimento do suor excessivo',
          ...
          <div className="mt-12 md:mt-16 text-center p-6 md:p-8 bg-gradient-to-r from-green-900/30 to-green-800/30 rounded-3xl border-2 border-green-400 backdrop-blur-sm">
            ...
            <p className="text-gray-200 mb-6 md:mb-8 text-lg">
              Faça seu próprio Gel Natural de Alívio para Suor em casa! Com ingredientes simples, você cria uma solução refrescante e eficaz, perfeita para combater o suor excessivo de forma natural.
            </p>
            <a
              href="https://pay.cakto.com.br/a8o524u_572837"
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8">
            <div className="bg-gradient-to-b from-red-900/20 to-red-800/20 p-6 md:p-8 rounded-3xl border-2 border-red-500/30 backdrop-blur-sm">
              ...
              <p className="text-gray-200 mb-4 leading-relaxed">Você já evitou apertar a mão de alguém por causa do suor? Ou escolheu roupas escuras para esconder manchas? A hiperidrose pode transformar cada momento em constrangimento, limitando sua confiança e qualidade de vida. Você sente:</p>
              <ul className="space-y-3 text-gray-200">
                <li className="flex items-start gap-3"><span className="text-white font-bold">•</span> Suor incontrolável nas mãos, pés ou axilas</li>
                <li className="flex items-start gap-3"><span className="text-white font-bold">•</span> Vergonha em situações sociais ou profissionais</li>
                <li className="flex items-start gap-3"><span className="text-white font-bold">•</span> Frustração com produtos que irritam a pele ou não funcionam</li>
                <li className="flex items-start gap-3"><span className="text-white font-bold">•</span> Medo de tratamentos caros ou invasivos que não resolvem</li>
              </ul>
            </div>
            <div className="bg-gradient-to-b from-emerald-900/20 to-green-800/20 p-6 md:p-8 rounded-3xl border-2 border-emerald-500/50 backdrop-blur-sm">
              ...
              <p className="text-gray-200 mb-4 leading-relaxed">Com o Seca Fácil, você pode recuperar sua confiança! Nosso <span className="font-bold">Gel Natural de Alívio para Suor</span>, feito com ingredientes naturais como aloe vera e óleos essenciais, reduz o suor excessivo sem químicos. Você terá:</p>
              <ul className="space-y-3 text-gray-200">
                <li className="flex items-start gap-3"><span className="text-white font-bold">✓</span> Alívio natural em apenas 7 dias</li>
                <li className="flex items-start gap-3"><span className="text-white font-bold">✓</span> Gel simples para preparar em casa</li>
                <li className="flex items-start gap-3"><span className="text-white font-bold">✓</span> Sem efeitos colaterais ou químicos agressivos</li>
                <li className="flex items-start gap-3"><span className="text-white font-bold">✓</span> Liberdade para viver sem constrangimento</li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8">
            <div className="bg-gradient-to-b from-gray-800/40 to-gray-900/40 p-6 md:p-8 rounded-3xl border-2 border-emerald-500/50 backdrop-blur-sm">
              ...
              />
              <p className="text-gray-200 text-sm italic">*Imagem ilustrativa: gel simples para alívio do suor excessivo.</p>
            </div>
            <div className="bg-gradient-to-b from-gray-800/40 to-gray-900/40 p-6 md:p-8 rounded-3xl border-2 border-emerald-500/50 backdrop-blur-sm">
              <h3 className="text-xl md:text-2xl font-bold text-white mb-4">Redução do Suor: Antes e Depois</h3>
              <p className="text-gray-200 mb-6 leading-relaxed">Nossos usuários relatam uma redução significativa do suor em apenas 7 dias. Veja o progresso que você pode esperar:</p>
              <div className="bg-gray-700 p-6 rounded-xl mb-4">
                ...
                <p className="text-center text-sm text-gray-200 mt-4">Nível de Suor (0-10)</p>
              </div>
              <p className="text-gray-200 text-sm italic mt-4">*Gráfico ilustrativo: redução média do suor relatada por usuários.</p>
            </div>
          </div>
          <div className="mt-12 text-center">
            ...
            />
            <p className="text-gray-200 text-sm italic">Desenvolvido por especialistas para resultados reais.</p>
          </div>
          {/* Before/After Images */}
          <div className="mt-16 text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
              <div className="bg-gray-800/40 p-6 rounded-3xl border border-gray-700">
                <h4 className="text-lg font-bold text-white mb-4">Antes do Seca Fácil</h4>
                <img
                  src="data:image/svg+xml,%3Csvg width='300' height='200' xmlns='http://www.w3.org/2000/svg'%3E%3Crect width='100%25' height='100%25' fill='%23991B1B'/%3E%3Ctext x='50%25' y='30%25' font-family='Arial' font-size='14' fill='%23FFFFFF' text-anchor='middle'%3ESuor excessivo%3C/text%3E%3Ctext x='50%25' y='45%25' font-family='Arial' font-size='14' fill='%23FFFFFF' text-anchor='middle'%3Eno corpo todo%3C/text%3E%3Ctext x='50%25' y='60%25' font-family='Arial' font-size='12' fill='%23FFFFFF' text-anchor='middle'%3EConstrangimento%3C/text%3E%3Ctext x='50%25' y='75%25' font-family='Arial' font-size='12' fill='%23FFFFFF' text-anchor='middle'%3Esocial%3C/text%3E%3C/svg%3E"
                  alt="Ilustração mostrando suor excessivo antes do tratamento"
                  className="w-full h-auto rounded-xl mb-4 max-w-md mx-auto"
                />
                <p className="text-gray-200 text-sm">Suor que limita o dia a dia</p>
              </div>
              <div className="bg-gray-800/40 p-6 rounded-3xl border border-gray-700">
                <h4 className="text-lg font-bold text-white mb-4">Depois do Seca Fácil</h4>
                <img
                  src="data:image/svg+xml,%3Csvg width='300' height='200' xmlns='http://www.w3.org/2000/svg'%3E%3Crect width='100%25' height='100%25' fill='%23065F46'/%3E%3Ctext x='50%25' y='30%25' font-family='Arial' font-size='14' fill='%23FFFFFF' text-anchor='middle'%3EAlívio do suor%3C/text%3E%3Ctext x='50%25' y='45%25' font-family='Arial' font-size='14' fill='%23FFFFFF' text-anchor='middle'%3Eem 7 dias%3C/text%3E%3Ctext x='50%25' y='60%25' font-family='Arial' font-size='12' fill='%23FFFFFF' text-anchor='middle'%3EConfiança para%3C/text%3E%3Ctext x='50%25' y='75%25' font-family='Arial' font-size='12' fill='%23FFFFFF' text-anchor='middle'%3Eviver%3C/text%3E%3C/svg%3E"
                  alt="Ilustração mostrando alívio do suor e confiança para viver após o tratamento"
                  className="w-full h-auto rounded-xl mb-4 max-w-md mx-auto"
                />
                <p className="text-gray-200 text-sm">Volta à vida confiante e sem suor</p>
              </div>
            </div>
          </div>
        </div>
            ...
            {[
              {
                ...
                desc: 'Alivie a hiperidrose sem antitranspirantes químicos ou procedimentos invasivos',
                gradient: 'from-green-500 to-emerald-500'
              },
              {
                icon: '⏱️',
                title: 'Resultados em 7 Dias',
                desc: 'Sinta alívio rápido com nosso gel natural comprovado',
                gradient: 'from-blue-500 to-cyan-500'
              },
              {
                icon: '🏠',
                title: 'Fácil de Preparar em Casa',
                desc: 'Gel simples que não requer ingredientes caros',
                gradient: 'from-purple-500 to-pink-500'
              },
              {
                icon: '💪',
                title: 'Efeito Duradouro',
                desc: 'Reduza o suor futuro com ingredientes naturais',
                gradient: 'from-orange-500 to-red-500'
              },
              {
                icon: '🔒',
                title: 'Seguro e Comprovado',
                desc: 'Método desenvolvido por especialistas em controle de suor',
                gradient: 'from-yellow-500 to-orange-500'
              },
              {
                icon: '💸',
                title: 'Acessível e Vitalício',
                desc: 'Apenas R$5,00 para acesso ilimitado ao programa',
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="bg-gray-800/60 backdrop-blur-sm p-8 md:p-12 rounded-3xl border-2 border-emerald-500 shadow-2xl shadow-emerald-500/20">
            ...
            <p className="text-xl md:text-2xl font-bold text-gray-200 mb-4">
              Experimente o Seca Fácil sem risco
            </p>
            <p className="text-lg text-gray-200 mb-8 leading-relaxed">
              Use nossa fórmula por 7 dias completos. Se não sentir alívio, receba 100% do seu dinheiro de volta.
            </p>
            <div className="mb-8">
              <img
          ...
          <div className="grid grid-cols-1 md:grid-cols-1 gap-6 md:gap-8 mb-12">
            <div className="relative bg-gray-800/40 backdrop-blur-sm p-6 md:p-8 rounded-3xl border-2 border-emerald-500 scale-105 shadow-2xl shadow-emerald-500/20">
              ...
              <div className="text-center mb-6">
                <h3 className="text-2xl font-bold text-white mb-2">Seca Fácil Vitalício</h3>
                <div className="text-4xl md:text-5xl font-black mb-1 text-white">
                  <span className="line-through text-gray-400 text-2xl mr-2">R$47,00</span>
                  R$5,00
              ...
              <div className="mb-6">
                <img
                  src="data:image/svg+xml,%3Csvg width='400' height='250' xmlns='http://www.w3.org/2000/svg'%3E%3Crect width='100%25' height='100%25' fill='%23065F46'/%3E%3Ctext x='50%25' y='25%25' font-family='Arial' font-size='16' fill='%23FFFFFF' text-anchor='middle'%3ESECA FÁCIL%3C/text%3E%3Ctext x='50%25' y='40%25' font-family='Arial' font-size='12' fill='%23FFFFFF' text-anchor='middle'%3EGel Natural%3C/text%3E%3Ctext x='50%25' y='52%25' font-family='Arial' font-size='12' fill='%23FFFFFF' text-anchor='middle'%3EPara Suor Excessivo%3C/text%3E%3Ctext x='50%25' y='68%25' font-family='Arial' font-size='10' fill='%23D1D5DB' text-anchor='middle'%3EFórmula Completa%3C/text%3E%3Ctext x='50%25' y='80%25' font-family='Arial' font-size='10' fill='%23D1D5DB' text-anchor='middle'%3EAlívio em 7 Dias%3C/text%3E%3C/svg%3E"
                  alt="Visualização do produto Seca Fácil - Fórmula completa com gel natural para suor excessivo"
                  className="w-full h-auto rounded-2xl shadow-lg max-w-md mx-auto"
                />
              </div>
              <ul className="space-y-3 mb-8">
                {[
                  'Fórmula completa do gel natural para hiperidrose',
                  'Plano de 7 dias para alívio rápido do suor',
                  'Acesso vitalício ao programa completo',
                  'Instruções detalhadas para preparar o gel',
              ...
              <p className="text-center text-xs text-gray-200 mt-3">
                Pagamento único de R$5,00 • Sem taxas adicionais • Acesso imediato
              </p>
            </div>
          </div>
            ...
            {[
              {
                ...
                answer: 'Você adquire o Seca Fácil e tem 7 dias completos para testar a fórmula. Se não sentir alívio significativo do suor, pode solicitar reembolso total de 100% do valor pago, sem burocracia.'
              },
              {
                question: 'Preciso de ingredientes especiais para o gel?',
                answer: 'Não! O Gel Natural de Alívio para Suor do Seca Fácil é feito com ingredientes simples, como aloe vera e óleos essenciais, que você encontra facilmente. Não precisa de nada caro ou difícil de achar.'
              },
              {
                question: 'O gel é seguro para todas as idades?',
                answer: 'Sim, o Seca Fácil foi desenvolvido por especialistas e é seguro para a maioria das pessoas. O gel é natural e de baixo risco. Recomendamos consultar um médico se você tiver condições de saúde específicas.'
              },
              {
                question: 'Quanto tempo leva para sentir os resultados?',
                answer: 'A maioria dos nossos usuários relata alívio significativo do suor em apenas 7 dias aplicando o gel. Alguns sentem melhora já nos primeiros dias.'
              },
              {
                question: 'O acesso é realmente vitalício por R$5,00?',
                answer: 'Sim! Por apenas R$5,00, você tem acesso ilimitado e vitalício à fórmula completa. Sem mensalidades, taxas extras ou custos ocultos. É um pagamento único.'
              },
              {
                question: 'Como recebo o material após a compra?',
                answer: 'Após a confirmação do pagamento, você recebe acesso imediato à fórmula completa via e-mail. Todo o material fica disponível em uma área exclusiva online.'
              },
              {
                question: 'Funciona para casos graves de hiperidrose?',
                answer: 'O Seca Fácil foi desenvolvido para ajudar pessoas com diferentes níveis de suor excessivo. Muitos usuários com casos graves relataram melhora significativa. Para casos muito severos, recomendamos acompanhamento médico paralelo.'
              }
            ].map((faq, index) => (
              <div
                key={index}
      ...
      <section className="py-16 md:py-24 px-4 bg-gradient-to-br from-emerald-900/30 via-blue-900/20 to-purple-900/20">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-4xl md:text-6xl font-black mb-6 leading-tight text-white">
            Viva sem Suor Excessivo Hoje Mesmo<br />
            <span className="text-emerald-400">Comece Agora com Garantia</span>
          </h2>
          <p className="text-xl md:text-2xl text-gray-200 mb-10 leading-relaxed">
            Junte-se a milhares de pessoas que recuperaram a confiança com o Seca Fácil
          </p>
          <div className="mb-8">
            <img
              src="data:image/svg+xml,%3Csvg width='500' height='300' xmlns='http://www.w3.org/2000/svg'%3E%3Crect width='100%25' height='100%25' fill='%23065F46'/%3E%3Ctext x='50%25' y='25%25' font-family='Arial' font-size='20' fill='%23FFFFFF' text-anchor='middle'%3EVOLTA À VIDA CONFIANTE%3C/text%3E%3Ctext x='50%25' y='45%25' font-family='Arial' font-size='16' fill='%23FFFFFF' text-anchor='middle'%3ESem suor, sem constrangimento%3C/text%3E%3Ctext x='50%25' y='65%25' font-family='Arial' font-size='14' fill='%23D1D5DB' text-anchor='middle'%3EApenas R$5,00%3C/text%3E%3Ctext x='50%25' y='80%25' font-family='Arial' font-size='14' fill='%23D1D5DB' text-anchor='middle'%3EGarantia de 7 dias%3C/text%3E%3C/svg%3E"
              alt="Ilustração de pessoa vivendo sem suor excessivo após usar o Seca Fácil"
          ...
          <div className="flex items-center justify-center gap-4 text-sm text-gray-200 flex-wrap">
            ...
            <span>•</span>
            <span className="flex items-center gap-1">
              <span>🔒</span> Pagamento único R$5,00
            </span>
            <span>•</span>
            <span className="flex items-center gap-1">
              <span>⚡</span> Acesso imediato
        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-wrap justify-center gap-6 mb-8">
            {[
              ...
              { text: 'Suporte', href: 'mailto:suporte@secafacil.com' },
          ...
          <p className="text-center text-gray-200 text-sm mb-8">
            © 2025 Seca Fácil - Todos os direitos reservados
          </p>
          <div className="text-center text-gray-200 text-xs leading-relaxed space-y-4 max-w-4xl mx-auto">
            <p>
              <strong>Aviso Legal:</strong> Os resultados podem variar individualmente. O Seca Fácil é um programa de soluções naturais para alívio do suor excessivo, desenvolvido com base em conhecimento especializado. Este produto não substitui acompanhamento médico. Consulte um profissional de saúde antes de iniciar qualquer programa. O sucesso do programa depende da dedicação individual e fatores específicos de cada caso.
            </p>
            <p>
              <strong>Garantia:</strong> Oferecemos 7 dias de acesso completo com garantia incondicional de reembolso. Se não ficar satisfeito, solicite reembolso total dentro do prazo. Pagamento único de R$5,00, sem mensalidades ou taxas adicionais.
            </p>
            <p>
          ...
          <div className="max-w-4xl mx-auto my-8 bg-gray-900 rounded-3xl border border-gray-700 shadow-2xl">
            ...
            <div className="p-6 text-gray-200 leading-relaxed space-y-6">
              <div>
                ...
                <p>Ao adquirir o Seca Fácil, você concorda com estes Termos de Uso. Se não concordar com algum termo, não utilize nossos serviços.</p>
              </div>
              <div>
                <h3 className="text-lg font-bold text-white mb-2">2. Descrição do Serviço</h3>
                <p>O Seca Fácil é um programa educativo de soluções naturais para alívio do suor excessivo, baseado em métodos naturais. Não constitui aconselhamento médico e não substitui consulta com profissionais de saúde.</p>
              </div>
              <div>
              ...
              <div>
                ...
                <p>Você concorda em usar o programa de forma responsável. Recomendamos fortemente consultar um médico antes de iniciar qualquer programa, especialmente se tiver condições de saúde preexistentes.</p>
              </div>
              <div>
                <h3 className="text-lg font-bold text-white mb-2">5. Limitação de Responsabilidade</h3>
                <p>O Seca Fácil não garante resultados específicos. Os resultados podem variar entre indivíduos. Não nos responsabilizamos por reações derivadas do uso inadequado do gel.</p>
              </div>
              <div>
            ...
            <div className="p-6 text-gray-200 leading-relaxed space-y-6">
              ...
              <div>
                ...
                <p>
                  ...
                  <a href="mailto:suporte@secafacil.com" className="text-emerald-400 hover:underline">
                    suporte@secafacil.com
                  </a>
                </p>
              </div>
            </div>
